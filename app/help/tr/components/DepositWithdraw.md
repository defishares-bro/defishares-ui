[# receive]
### Kullanıcı adınız
Bitshares hesabınıza bir başkasından ya da bir borsadan DFS gönderimi için, göndericiye kullanıcı adınızı vermeniz yeterlidir. DFS'ler doğrudan kullanıcı adı belirtilerek gönderilir:
