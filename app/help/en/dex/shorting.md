...
In order to increase your exposure to DFS and offer liquidity to BitAssets, such
 ...
 * *settlement price*: The price for 1 DFS as it is traded on external exchanges.
...
offer to buy the collateral is less than the call price (x/DFS).
...
market rates up to the SQP and close the position. The remaining DFS of the
...
increase, an additional amount of DFS is locked as collateral, while reducing
