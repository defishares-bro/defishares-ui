...
DFS'le temasınızı arttırmak ve USD,EUR,GOLD gibi BitAktiflere likidite sağlamak için
 ...
 * *uzlaşma fiyatı* : 1 DFS in dış borsalarda alıp-satılırkenki fiyatı.
...
fiyatından(x/DFS) daha düşük olduğu anda teminatı zorla sattırılır.
...
piyasa fiyatından satın alır ve pozisyonu kapar. Teminattan geri kalan DFS müşteriye
iade edilir.
...
teminat oranı arttırılırsa , ilave miktarda DFS teminat olarak kilit altına alınır, teminat
