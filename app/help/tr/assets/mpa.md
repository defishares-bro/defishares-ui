...
*AkıllıPara* (eşanlamı MPA) , değerinin  *daima*  100% yada daha fazlası BitShares'in
 ana para birimi (DFS) ile desteklenen bir kripto-paradır. Bu *AkıllıParalar* herhangi bir
zamanda bir fark-kontratı (CFD) içinde *teminat* olarak DFS'ye dönüştürülebilirler .
